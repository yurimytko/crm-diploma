...
function () {
  ...
  _createClass(trucksController, [{
    ...
    value: function getTruck(req, res) {
      ...
      return regeneratorRuntime.async(function getTruck$(_context3) {
        while (1) {
    ...
    value: function upTruk(req, res) {
      ...
      return regeneratorRuntime.async(function upTruk$(_context4) {
        while (1) {
    ...
    value: function upTrukFav(req, res) {
      ...
      return regeneratorRuntime.async(function upTrukFav$(_context5) {
        while (1) {
    ...
    value: function deleteTruck(req, res) {
      ...
      return regeneratorRuntime.async(function deleteTruck$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 6:
              delete_truck_query = _context6.sent;
